...
const HomePageCard = (props) => {
  ...
  useEffect(() => {
    if (stock.ticker) {
      ...
      let tickerInfo = axios.get(`/api/ticker/${stock.ticker}`)
      let price = axios.get(`/api/price/${stock.ticker}`)
      let chart = axios.get(`/api/chart/${stock.ticker}`)
      let quote = axios.get(`/api/quote/${stock.ticker}`)
